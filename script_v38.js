...
function renderHistoricoMensualVentas() {
  ...
  _chartHistPrecioDesc = new Chart(c1, {
    ...
    options: {
      ...
      scales:{
        y:  { position:'left',  ticks:{ callback:v=>v+'%' }, title:{display:true,text:'% Descuento'} },
        y1: { position:'right', grid:{drawOnChartArea:false}, ticks:{ callback:v=>'$'+Number(v).toLocaleString('es-BO') }, title:{display:true,text:'Precio de Venta'} },
      }
    }
  });
  ...
  _chartHistM2Cant = new Chart(c2, {
    ...
    options: {
      ...
      scales:{
        y:  { position:'left',  ticks:{ callback:v=>'$'+v }, title:{display:true,text:'$/m²'} },
        y1: { position:'right', grid:{drawOnChartArea:false}, ticks:{ precision:0 }, title:{display:true,text:'Cantidad'} },
      }
    }
  });
}
