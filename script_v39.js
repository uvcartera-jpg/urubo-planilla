  ...
  el.innerHTML = `<div class="funnel-viz">` + funnelData.map(f => {
    ...
    <div class="funnel-stage">
      <div class="funnel-bar-wrap">
        <div class="funnel-bar" style="width:${pctWidth}%;background:linear-gradient(135deg,${f.color},${f.color}bb);">
  ...
  _chartsAuxiliares[canvasId] = new Chart(canvas, {
    ...
    options: {
      ...
      plugins:{
        ...
        datalabels:{ anchor:'end', align:'end', font:{weight:'700', size:11}, color:(ctx)=>ctx.dataset.backgroundColor[ctx.dataIndex] }
      },
      scales:{
