...
async function guardarYGenerarCotizacion() {
  ...
  const data = {
    ...
    descuentoPct: parseFloat(document.getElementById('cotiz-descuento-pct').value)||0,
          ...
          <div class="res">
            ...
            <div class="grid2" style="margin-top:8px;">
              ...
              <div class="fact">
                ...
                <div class="b">
                  ...
                  <div><span>Descuento</span><span class="num">${c.descuentoPct||0}%</span></div>
                  <div class="sep"></div>
                  <div class="tot"><span>Final</span><b class="num" style="color:#D62828;">${fmt(c.precioFinal)}</b></div>
                </div>
                <div class="pie ${hayDescuento?'rojo':''}">${hayDescuento ? (c.descuentoPct+'% menos') : 'Precio de lista'}</div>
              </div>
            </div>
            ...
            <div class="precio">
              ...
              <div class="fila">
                ...
                ${hayDescuento ? `<span class="badge-desc">−${c.descuentoPct}% copropietarios Urubó Village</span>` : ''}
              </div>
...
function actualizarSimulador() {
  ...
  const pctDescuentoInput = parseFloat(inpDescuento.value) || 0;
  ...
  const pctDescuento = Math.min(pctDescuentoInput, pctMax);

  const precioFinal = precioLista * (1 - pctDescuento/100);
...
function generarCotizacionDesdeSimulador() {
  ...
  const precioLista = parseFloat(document.getElementById('sim-precio').value) || 0;
  const pctDescuento = Math.min(parseFloat(document.getElementById('sim-descuento-aplicar').value) || 0,
                                 parseFloat(document.getElementById('sim-descuento-aplicar').max) || 0);
...
async function guardarYGenerarCotizacionUsuario() {
  ...
  const data = {
    ...
    descuentoPct: parseFloat(document.getElementById('uc-descuento-pct').value)||0,
