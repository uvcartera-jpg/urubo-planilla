...
const ESTADOS_COLOR = {
  ...
  'Mora 61-90':'var(--danger)', 'Mora +91':  '#8b1a1a',
...
function renderExpensasAdmin() {
  ...
  const ESTADOS_KPI = ['Adelantado','Vigente','Mora 1-30','Mora 31-60','Mora 61-90','Mora +91'];
  const porEstado = {};
  ...
  const idsEstado = { 'Adelantado':'adelantado', 'Vigente':'vigente', 'Mora 1-30':'mora1', 'Mora 31-60':'mora2', 'Mora 61-90':'mora3', 'Mora +91':'mora4' };
