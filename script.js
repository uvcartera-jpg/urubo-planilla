...
function renderTendenciaMarketing(canvasId) {
  ...
  _chartsTendenciaMarketing[canvasId] = new Chart(canvas, {
    ...
    data: {
      ...
      datasets: [
        { label:'Leads', data:datosPorBucket.map(b=>b.leads), borderColor:'#7b5ea7', backgroundColor:'transparent', tension:.35, pointRadius:3 },
        { label:'Visitas agendadas', data:datosPorBucket.map(b=>b.agendadas), borderColor:'#3b82c4', backgroundColor:'transparent', tension:.35, pointRadius:3 },
        { label:'Visitas concretadas', data:datosPorBucket.map(b=>b.concretadas), borderColor:'#c07a2a', backgroundColor:'transparent', tension:.35, pointRadius:3 },
        { label:'Cierres', data:datosPorBucket.map(b=>b.cierres), borderColor:'#2d5a27', backgroundColor:'rgba(45,90,39,.08)', fill:true, tension:.35, pointRadius:3 },
      ]
    },
    options: {
...
function renderHistoricoMensualVentas() {
  ...
  _chartHistPrecioDesc = new Chart(c1, {
    ...
    data: {
      labels,
      datasets: [
        { label:'% Descuento', data:descPromedios, borderColor:'#3b82c4', backgroundColor:'transparent', yAxisID:'y', tension:.3, pointRadius:3 },
        { label:'Precio de Venta', data:precioPromedios, borderColor:'#1c2b1a', backgroundColor:'transparent', yAxisID:'y1', tension:.3, pointRadius:3 },
      ]
    },
    options: {
      responsive:true, maintainAspectRatio:false,
      ...
      scales:{
        y:  { position:'left', beginAtZero:true, ticks:{ maxTicksLimit:6, callback:v=>Math.round(v*10)/10+'%' }, title:{display:true,text:'% Descuento'} },
        y1: { position:'right', beginAtZero:true, grid:{drawOnChartArea:false}, ticks:{ maxTicksLimit:6, callback:v=>'$'+Math.round(v).toLocaleString('es-BO') }, title:{display:true,text:'Precio de Venta'} },
      }
    }
  });
  ...
  _chartHistM2Cant = new Chart(c2, {
    ...
    data: {
      labels,
      datasets: [
        { label:'$/m²', data:m2Promedios, borderColor:'#3b82c4', backgroundColor:'transparent', yAxisID:'y', tension:.3, pointRadius:3 },
        { label:'Cantidad de ventas', data:cantidades, borderColor:'#1c2b1a', backgroundColor:'transparent', yAxisID:'y1', tension:.3, pointRadius:3 },
      ]
    },
    options: {
      responsive:true, maintainAspectRatio:false,
      ...
      scales:{
        y:  { position:'left', beginAtZero:true, ticks:{ maxTicksLimit:6, callback:v=>'$'+Math.round(v) }, title:{display:true,text:'$/m²'} },
        y1: { position:'right', beginAtZero:true, grid:{drawOnChartArea:false}, ticks:{ maxTicksLimit:6, precision:0, stepSize:1 }, title:{display:true,text:'Cantidad'} },
      }
    }
  });
}
  ...
  _chartsAuxiliares[canvasId] = new Chart(canvas, {
    ...
    options: {
      ...
      scales:{
        ...
        y:{ grid:{display:false}, ticks:{ font:{ family:"'DM Sans',sans-serif", size:11.5, weight:'600' }, color:'#3a4740' } }
      },
...
function renderHomeChartVentasTendencia() {
  ...
  _chartsHome['h-chart-ventas-linea'] = new Chart(canvas, {
    ...
    options: {
      ...
      maintainAspectRatio:false, scales:{ y:{ beginAtZero:true, ticks:{precision:0} } }
    }
  });
}
...
async function renderTendenciaExpensas() {
  ...
  _chartTendenciaExpensas = new Chart(canvas, {
    ...
    data: {
      ...
      datasets: [
        { label:'Cobranza', data: ordenados.map(b=>b.monto), borderColor:'#1f6b3a', backgroundColor:'rgba(31,107,58,.10)',
          fill:true, tension:.35, pointRadius:3, pointBackgroundColor:'#1f6b3a' },
        { label:'Meta', data: metaPorBucket, borderColor:'#c07a2a', borderDash:[6,4], backgroundColor:'transparent',
          fill:false, tension:.2, pointRadius:2, pointBackgroundColor:'#c07a2a' }
      ]
    },
    options: {
      responsive: true,
      ...
      scales: {
        y: { ticks: { callback: v => 'Bs '+Number(v).toLocaleString('es-BO',{maximumFractionDigits:0}) } },
