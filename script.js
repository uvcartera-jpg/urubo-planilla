...
async function mostrarCotizacionPublica(key) {
  ...
  document.body.innerHTML = `<div id="cotiz-publica-root" style="min-height:100vh;background:#F7F5F0;display:flex;align-items:center;justify-content:center;font-family:'Inter',sans-serif;">
