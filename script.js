...
async function mostrarCotizacionPublica(key) {
  ...
  root.innerHTML = `
    <style>
      ...
      .cp-hero{ position:relative; height:70vh; min-height:420px; background:url('entrada.jpg') center/cover; display:flex; align-items:flex-end; }
    ...
    <div class="cp-wrap">
      ...
      <div class="cp-section">
        <div class="cp-grid2">
          <img class="cp-photo" src="pileta.jpg" alt=""/>
          <img class="cp-photo" src="jardin.jpg" alt=""/>
        </div>
      </div>
