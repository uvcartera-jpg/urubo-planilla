  ...
  root.innerHTML = `
    <style>
      ...
      *{box-sizing:border-box;}
      ...
      .cp-photos2{ display:flex; gap:2px; }
      .cp-photos2 img{ flex:1; width:50%; height:280px; object-fit:cover; display:block; }
      ...
      @media(max-width:480px){ .cp-photos2{ flex-direction:column; } .cp-photos2 img{ width:100%; } }
    </style>
    ...
    <img class="cp-photo-full" src="entrada.jpg" alt="">
    ...
    <div class="cp-photos2">
      <img src="pileta.jpg" alt=""><img src="jardin.jpg" alt="">
    </div>
