...
async function renderDashboardExpensas() {
  ...
  dbeCharts.semanal = new ApexCharts(document.querySelector('#dbe-chart-semanal'), {
    chart: { type:'line', height:260, toolbar:{show:false}, background:'transparent', foreColor:'#94a3b8' },
    series: [
  ...
  dbeCharts.mensual = new ApexCharts(document.querySelector('#dbe-chart-mensual'), {
    chart: { type:'area', height:260, toolbar:{show:false}, background:'transparent', foreColor:'#94a3b8' },
    series: [
  ...
  dbeCharts.modalidad = new ApexCharts(document.querySelector('#dbe-chart-modalidad'), {
    chart: { type:'donut', height:260, background:'transparent', foreColor:'#94a3b8' },
  ...
  dbeCharts.velas = new ApexCharts(document.querySelector('#dbe-chart-velas'), {
    chart: { height:340, toolbar:{show:false}, background:'transparent', foreColor:'#94a3b8', parentHeightOffset:0 },
    series: [
