...
function actualizarSimulador() {
  ...
  // Descuento según la política vigente para esta modalidad + categoría — no se tipea a mano.
  let pctDescuento = 0;
  ...
  if (modalidad && categoria) {
    ...
    if (politica) {
      pctDescuento = politica.pctMax;
      notaEl.innerHTML = `✅ Política vigente para <strong>${esc(modalidad)} · Categoría ${esc(categoria)}</strong>: hasta <strong style="color:var(--ok);">${pctDescuento}% de descuento</strong>.`;
    } else {
